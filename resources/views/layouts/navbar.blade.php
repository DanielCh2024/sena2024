<div class="navbar bg-base-100 shadow-lg">
  ...
  <div class="flex-1 md:hidden">
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
        <li><a href="{{ route('home') }}">MR. JEANS TIENDA</a></li>
  ...
  <div class="flex-1 hidden md:flex space-x-4">
    <a href="{{ route('home') }}" class="btn btn-ghost btn-sm">MENÚ PRINCIPAL</a>
    <a href="{{ route('productos.index') }}" class="btn btn-ghost btn-sm">Catálogo Tienda</a>
  </div>

  {{-- Si esta autenticado muestra menu de usuario, sino muestra botones de login y registro --}}
  @auth
      <h3 class="mr-4 font-semibold">Bienvenido a MR. JEANS TIENDA, {{ auth()->user()->name }}</h3>
      <div class="dropdown dropdown-end">
        ...
        <ul tabindex="0" class="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
          <li>
            <a href="{{ route('dashboard') }}">Panel Administrador</a>
          </li>
          <li>
